...
var splash_radius = 146 * HU:#2.3: #146 * HU:
	set(new):
...
#		var dir := global_position.direction_to(player_global_center)
#		begin_offset = Vector3(
#				dir.x * 1.0 * HU, 
#				dir.y * 30.0 * HU,
#				dir.z * 1.0 * HU).length()
#		print(begin_offset)
